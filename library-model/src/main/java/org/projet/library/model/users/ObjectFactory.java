 ...
 * generated in the org.projet.library.model.users package. 
...
public class ObjectFactory {
    ...
    private final static QName _IdUser_QNAME = new QName("http://webapp.libraryservice.projet.org/", "idUser");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.projet.library.model.users
     * 
     */
    ...
    /**
     * Create an instance of {@link IdUser }
     * 
     */
    public IdUser createIdUser() {
        return new IdUser();
    }
    ...
    /**
     * Create an instance of {@link IdUserResponse }
     * 
     */
    public IdUserResponse createIdUserResponse() {
        return new IdUserResponse();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link IdUser }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://webapp.libraryservice.projet.org/", name = "idUser")
    public JAXBElement<IdUser> createIdUser(IdUser value) {
        return new JAXBElement<IdUser>(_IdUser_QNAME, IdUser.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link IdUserResponse }{@code >}}
     * 
     */
