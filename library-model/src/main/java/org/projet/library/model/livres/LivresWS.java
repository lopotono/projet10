...
public interface LivresWS {
    ...
    @RequestWrapper(localName = "doSearch", targetNamespace = "http://webapp.libraryservice.projet.org/", className = "org.projet.library.model.livres.DoSearch")
    @ResponseWrapper(localName = "doSearchResponse", targetNamespace = "http://webapp.libraryservice.projet.org/", className = "org.projet.library.model.livres.DoSearchResponse")
