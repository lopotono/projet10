...
<body>
	...
	<div class="jumbotron">
		<div class="container">
			<h6>
				<s:checkbox name="rappel" value="rappel" fieldValue="true"
					label="Vous pouvez
					activer cette option pour le rappel de fin de prêt." />
			</h6>
			<s:url action="rappel" var="rappellink">
				<s:param name="id">
					<s:property value="id" />
				</s:param>
			</s:url>
			<h3>
				<a href="${rappellink}" class="badge badge-info">ACTIVER
					OPTION</a>
			</h3>
		</div>
	</div>
